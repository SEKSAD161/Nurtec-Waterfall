...
for idx, p in enumerate(parts):
    sql = ("INSERT INTO VAW_AMER_DESIGN.USPRIMARYCAREADHOCANALYTICSPARTC._wf_b64 "
           "(chunk_id, chunk, fname) VALUES (" + str(idx) + ", '" + p + "', 'streamlit_app.py');")
    open(rf'c:\Users\SEKSAD\.snowflake\cortex\playground\workspace\_sa6_{idx:02d}.sql', 'w', newline='').write(sql)
print('chunks:', len(parts), 'b64 len:', len(b))
